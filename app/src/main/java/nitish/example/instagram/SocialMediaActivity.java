...
public class SocialMediaActivity extends AppCompatActivity {
    ...
    //getting the result from the selected image
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        super.onActivityResult(requestCode, resultCode, data);

        //getting the image and uploading to the server
        if (requestCode == 4000 && resultCode == RESULT_OK && data != null){

            //getting the image and converting into the byte array
            try{
                    ...
                    public void done(ParseException e) {
                        ...
                        if(e == null){
                            ...
                            FancyToast.makeText(SocialMediaActivity.this,
                                    "Picture Uploaded", Toast.LENGTH_SHORT, FancyToast.SUCCESS,
                                    true).show();
                        }
                        else{
